...
function Signup() {
    const [userAuth, setUserAuth] = useState({ fullname: "", email: "", password: "",  })
...
return (
    <div>
        <div className="container" style={{ width: "500px", height: "600px", borderRadius: "10%", border: "2px solid", marginTop: "50px", textAlign: "center" }}>
            <button style={{ width: "50px", height: "50px", borderRadius: "50%", backgroundColor: "#3cbda9", marginTop: "10px" }}><i>S</i></button>
